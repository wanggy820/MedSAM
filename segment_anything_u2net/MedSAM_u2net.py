...
class MedSAM_U2net(Dataset):
    def __init__(self, sam, image_list, mask_list, auxiliary_list, bbox_shift=0, ratio=1.02):
        ...
        self.img_size = sam.image_encoder.img_size  # 512
    ...
    def __getitem__(self, idx):
        ...
        auxiliary_ratio_256 = auxiliary_ratio[top:bottom, left:right]
        auxiliary_ratio_256 += auxiliary_256
        auxiliary_ratio_256 = auxiliary_ratio_256 // 2 + auxiliary_ratio_256 % 2
        prompt_masks = torch.where(auxiliary_ratio_256 > 0, 1.0, 0.0).unsqueeze(0)
        #####################################
        ...
        auxiliary_ratio_masks = torch.where(auxiliary_ratio_masks > 0, 1, 0)
        #####################################
