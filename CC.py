...
def main():
    ...
    img_name_list = ["/Users/wang/Desktop/MedSAM-main/datasets/ISBI/ISBI2016_ISIC_Part1_Training_Data/ISIC_0000001.jpg"]
    # --------- 2. dataloader ---------
    # 1. dataloader
...
if __name__ == "__main__":
    ...
    #
    # # 替换为你的.mat文件路径
    # mat_file_path = '/Users/wang/Downloads/brainTumorDataPublic_1766/99.mat'
    #
    # # 加载.mat文件
    ...
    fea_path = h5py.File('/Users/wang/Downloads/brainTumorDataPublic_1766/99.mat')
    print(type(fea_path))
    print(fea_path.keys())
    print(fea_path.values())
